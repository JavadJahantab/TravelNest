...
namespace TravelNest.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FlightTicketPurchases",
                columns: table => new
                {
                    FlightTicketPurchaseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    FlightId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightTicketPurchases", x => x.FlightTicketPurchaseId);
                    table.ForeignKey(
                        name: "FK_FlightTicketPurchases_Flights_FlightId",
                        column: x => x.FlightId,
                        principalTable: "Flights",
                        principalColumn: "FlightId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlightTicketPurchases_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Airports_Address_LocationAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hotels_Address_LocationAddressId",
                        column: x => x.LocationAddressId,
                        principalTable: "Address",
                        principalColumn: "AddressId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomReservations_HotelRooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "HotelRooms",
                        principalColumn: "HotelRoomId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomReservations_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "HotelId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Airports_LocationAddressId",
                table: "Airports",
                column: "LocationAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightTicketPurchases_FlightId",
                table: "FlightTicketPurchases",
                column: "FlightId");

            migrationBuilder.CreateIndex(
                name: "IX_FlightTicketPurchases_UserId",
                table: "FlightTicketPurchases",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hotels_LocationAddressId",
                table: "Hotels",
                column: "LocationAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomReservations_HotelId",
